...
function Library:GetColor(color, table)
    ...
    if (color.R == nil) then return Color3.fromRGB(240, 232, 0) end
...
function Library:CreateWindow(title, color)
    ...
    color = color and Library:GetColor(color) or Color3.fromRGB(240, 232, 0)
    ...
    outlinecore.BackgroundColor3 = Color3.fromRGB(71, 4, 255)
